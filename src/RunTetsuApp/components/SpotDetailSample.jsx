...
class SpotDetailSample extends React.Component {
  render() {
    const { props } = this;
    const { spotDetailSample } = styles;
    ...
    return (
      <article>
       ...
       <section
          ...
          className={spotDetailSample.cover}
        >
        </section>
        <section className={spotDetailSample.main}>
          <TextField
            label="開催日時"
            type="date"
...
export default SpotDetailSample;
